...
namespace OasysGH.UI
{
  ...
  /// 
  /// To use this method override CreateAttributes() in component class and set m_attributes = new Bool6ComponentAttributes(...
  /// </summary>
  public class Bool6ComponentAttributes : GH_ComponentAttributes
  {
    public Bool6ComponentAttributes(GH_Component owner, Action<bool, bool, bool, bool, bool, bool> updateHandle, string spacerText, bool resx, bool resy, bool resz, bool resxx, bool resyy, bool reszz) : base(owner)
    {
      x = resx;
      y = resy;
      z = resz;
    ...
    protected override void Render(GH_Canvas canvas, Graphics graphics, GH_CanvasChannel channel)
    {
      ...
      if (channel == GH_CanvasChannel.Objects)
      {
        ...
        //draw the component
        RenderComponentCapsule(canvas, graphics, true, true, true, true, true, true);
