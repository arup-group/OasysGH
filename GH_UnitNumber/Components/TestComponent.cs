...
namespace GH_UnitNumber.Components
{
  public class TestComponent : GH_OasysDropDownComponent
  {
    ...
    protected override void SolveInstance(IGH_DataAccess DA)
    {
      ...
      Output.SetItem(this, DA, 0, new OasysGH.Units.GH_UnitNumber(first.ToUnit(LengthUnit)));
      Output.SetList(this, DA, 1, new List<OasysGH.Units.GH_UnitNumber>(second.Select(x => new OasysGH.Units.GH_UnitNumber(x.ToUnit(LengthUnit)))));
      Output.SetTree(this, DA, 2, new DataTree<OasysGH.Units.GH_UnitNumber>(new List<OasysGH.Units.GH_UnitNumber>(second.Select(x => new OasysGH.Units.GH_UnitNumber(x.ToUnit(LengthUnit))))));
