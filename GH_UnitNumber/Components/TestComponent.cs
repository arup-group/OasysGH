...
//      Output.SetItem(this, DA, 0, new OasysGH.Parameters.GH_UnitNumber(first.ToUnit(LengthUnit)));
//      Output.SetList(this, DA, 1, new List<OasysGH.Parameters.GH_UnitNumber>(second.Select(x => new OasysGH.Parameters.GH_UnitNumber(x.ToUnit(LengthUnit)))));
//      Output.SetTree(this, DA, 2, new DataTree<OasysGH.Parameters.GH_UnitNumber>(new List<OasysGH.Parameters.GH_UnitNumber>(second.Select(x => new OasysGH.Parameters.GH_UnitNumber(x.ToUnit(LengthUnit))))));
