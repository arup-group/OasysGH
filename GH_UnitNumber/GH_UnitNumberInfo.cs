...
namespace GH_UnitNumber {
  ...
  public class GH_UnitNumberInfo : GH_AssemblyInfo {
    ...
    public override string Description => "A small plugin enabling use of units in Grasshopper through UnitsNets and OasysUnits";
  ...
  internal sealed class PluginInfo {
    ...
    private static readonly Lazy<OasysPluginInfo> lazy = new Lazy<OasysPluginInfo>(()
      => new OasysPluginInfo(GH_UnitNumberInfo.ProductName, GH_UnitNumberInfo.PluginName,
        GH_UnitNumberInfo.Vers, GH_UnitNumberInfo.isBeta,
